...
module Poly_with_kind : sig
  ...
  include sig
    ...
    val quickcheck_generator
      : ('a : value_or_null).
      ('a : value_or_null) Ppx_quickcheck_runtime.Base_quickcheck.Generator.t
      -> ('a : value_or_null) t Ppx_quickcheck_runtime.Base_quickcheck.Generator.t

    val quickcheck_observer
      : ('a : value_or_null).
      ('a : value_or_null) Ppx_quickcheck_runtime.Base_quickcheck.Observer.t
      -> ('a : value_or_null) t Ppx_quickcheck_runtime.Base_quickcheck.Observer.t

    val quickcheck_shrinker
      : ('a : value_or_null).
      ('a : value_or_null) Ppx_quickcheck_runtime.Base_quickcheck.Shrinker.t
      -> ('a : value_or_null) t Ppx_quickcheck_runtime.Base_quickcheck.Shrinker.t
  end
  [@@ocaml.doc "@inline"]
