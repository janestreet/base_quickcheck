...
let quickcheck_generator_or_null = (Generator.or_null [@mode p])
let quickcheck_generator_list = (Generator.list [@mode p])
let quickcheck_generator_array = (Generator.array [@mode p])
let quickcheck_generator_iarray = (Generator.iarray [@mode p])
...
let quickcheck_observer_or_null = (Observer.or_null [@mode p])
let quickcheck_observer_list = (Observer.list [@mode p])
let quickcheck_observer_array = (Observer.array [@mode p])
let quickcheck_observer_iarray = (Observer.iarray [@mode p])
...
let quickcheck_shrinker_or_null = (Shrinker.or_null [@mode p])
let quickcheck_shrinker_list = (Shrinker.list [@mode p])
let quickcheck_shrinker_array = (Shrinker.array [@mode p])
let quickcheck_shrinker_iarray = (Shrinker.iarray [@mode p])
